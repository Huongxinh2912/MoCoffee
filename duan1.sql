...
--
-- Host: localhost:3306
-- Generation Time: Nov 30, 2024 at 03:45 PM
...
(1, 'Chưa có danh mục', 'capuchino4.jpg', 1),
(2, 'Truyền thống', 'phin.jpg', 1),
(4, 'Hiện đại', 'matcha.jpg', 1),
(6, 'Bạc xỉu', 'bacxiu.jpg', 1),
(16, 'Capuchino', 'latte3.jpg', 1),
(17, 'Sữa đá', 'suada.jpg', 1);
...
(49, 15, '2024-11-30 22:40:58', 100000, '9 trinh van bo - nam tu liem', '0981045365', '', 2);
...
(15, 'quang2107', '$2y$10$f2HxoSbR1SNNuS6GmAZy5.JWF6OrS.6J8KZ0Z7TgHk7U4oUkhYsaK', 'quang', 'user-default.png', 'clonechinh2107@gmail.com', '0981045365', '9 trinh van bo - nam tu liem', 0, 1);
...
--
ALTER TABLE `orderdetails`
  MODIFY `orderdetails_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
