                                ...
                                <form action="index.php" method="post">
                                    <div class="price-input">
                                        ...
                                        <input type="text" id="minamount" name="minamount"
                                            placeholder="Nhập giá tối thiểu" required>
                                        <p>đến</p>
                                        <input type="text" id="maxamount" name="maxamount" placeholder="Nhập giá tối đa"
                                            required> <br>
                            ...
                            <div class="product__item sale">
                                <div class="product__item__pic set-bg" data-setbg="upload/<?= $image ?>">
                                    ...
                                    <ul class="product__hover">
                                        ...
                                        <li>
                                            <a
                                                href="index.php?url=chitietsanpham&id_sp=<?= $product_id ?>&id_dm=<?= $category_id ?>"><span
                                        ...
                                        <li>
                                            ...
                                            <?php } else { ?>
                                                <button type="submit"
                                                    onclick="alert('Vui lòng dăng nhập để thực hiện chức năng');"
                                ...
                                <div class="product__item__text">
                                    ...
                                    <div class="product__price"><?= number_format($sale_price) . "₫" ?>
                                        <span><?= number_format($price) . "đ" ?> </span></div>
                                </div>
                            </div>
                        </div>
                    <?php
