                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner" style="border-radius: 10px;">
                        <div class="carousel-item active" >
                            <img class="img-fluid" src="public/img/banner/banner.png" alt="Image">
                            
                        </div>
                        <div class="carousel-item" >
                            <img class="img-fluid" src="public/img/banner/banner3.png" alt="Image">
                            
                        </div>
                        <div class="carousel-item" >
                            <img class="img-fluid" src="public/img/banner/banner2.png" alt="Image">
...
<!-- Banner Section Begin -->
<section class="banner set-bg" data-setbg="public/img/banner/banner.png">
    <div class="container">
        <div class="row">
