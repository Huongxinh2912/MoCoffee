                                                ...
                                                <td class="cart__quantity">
                                                    <div class="input-group float-left">
                                                        <div class="input-next-cart d-flex">
                                                            <input type="number" step="1" value="<?= $product_quantity ?>"
                                                                name="quantity[]" class="quantity-field-cart"
                                                                data-product-id="<?= $product_id ?>" onchange="updateCart(this)">
                                                        </div>
                                                    </div>
                                                </td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="cart__btn update__btn">
                                ...
                                <button name="update_cart" type="submit"></button>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        fetch('update_cart.php', {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    // Cập nhật giá trị tổng thanh toán nếu cần
                } else {
